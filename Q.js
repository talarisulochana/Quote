...
let quote = document.getElementById("quote")
        ...
        const quotes = [
            ...
            "జీవితం అంటే నువ్వు ఏమిటని ఊహించుకోవడం కాదు, నిన్ను నువ్వు రూపు దిద్దుకోవటం.",
"పోగొట్టుకున్న దాని గురించి ఏడవటం కన్నా, కావాలసిన దాన్ని పొందడం కోసం ప్రయత్నించడం మిన్న,",
"ఎక్కువగా నమ్మటం, ఎక్కువగా ప్రేమించటం, ఎక్కువగా ఆశించటం వలన వచ్చే బాధ కూడా ఎక్కువగానే ఉంటుంది."
        ];
        function getQuote() {
